                                ...
                                <div className="flex-content">
                                    ...
                                    <div className="flex-column main-messages" style={{height: "fit-content", display: "flex", flexdirection: "column"}}>
                                        ...
                                        <div className="card" style={{display: "webkit-flex", flexshrink: "2", backgroundcolor: "blue"}}>
                                            <form action="" className="card-footer text muted" >
                                                <div className="flex">
                                                    <div className="d-flex align-items-center pr-2">
                                                    </div>
                                                    <div className="flex-grow-1">
                                                        <input type="text" placeholder="Text Message" id="m" autoComplete="off" className="form-control h-100" value={this.state.message} onChange={ev => this.setState({ message: ev.target.value })} />
                                                    </div>
                                                    <button className="custom-send" onClick={this.sendMessage}>Send</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
