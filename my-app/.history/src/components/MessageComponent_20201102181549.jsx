                                            ...
                                            <div className="input-group">
                                                ...
                                                <div className="input-group-btn col-2">
                                                    <button type="submit" className="btn btn-primary"type="button"
                                                         ...
                                                         <div  className="publisher-btn"  data-abc="true"><i className="fa fa-meh-o"></i> <div className="publisher-btn text-info"  data-abc="true"><i className="fa fa-paper-plane"></i></div> </div>
                                                    </button>
