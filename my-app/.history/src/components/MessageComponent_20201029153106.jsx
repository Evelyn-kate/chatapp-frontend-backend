                                ...
                                <div className="container">
                                    <div className="panel panel-info">
                                        ...
                                        <div className="panel-body">
                                            ...
                                            <div className="row">
                                                <span className="form-group pull-right">
                                                    <input type="text" placeholder="Search.." className="form-control col-5"/>
                                                    <button type="" className="btn btn-sm btn-primary col-2"> <i className="fa fa-search"></i></button>
                                                </span>
                                            </div>
