                                    ...
                                    <div className="panel panel-info">
                                        ...
                                        <div className="panel-body">
                                            ...
                                            <div className="card bg-light mb-3">
                                                ...
                                                <div className="card-body">
                                                    <input type="radio"/>  <p className="card-text">Pop-Up Screen</p><br/>
                                                    <input type="radio"/>  <p className="card-text">Message Notifications</p><br/>
                                                    <input type="radio"/>  <p className="card-text">Mute</p><br/>
                                                    <input type="radio"/>  <p className="card-text">Vibrate</p><br/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
