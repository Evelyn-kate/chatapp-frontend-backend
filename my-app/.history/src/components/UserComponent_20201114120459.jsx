...
class UserComponent extends React.Component {
    ...
    render() {
        return (
            <div className="App">
                <Form handleFormSubmit={this.handleFormSubmit} handleInputChange={this.handleInputChange} newUsername={this.state.username} newEmail={this.state.email} newPassword={this.state.password} />
