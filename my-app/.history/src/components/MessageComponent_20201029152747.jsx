                                        ...
                                        <div className="panel-body">
                                            ...
                                            <div className="row">
                                                <div className="form-group">
                                                    <input type="text" placeholder="Search.." className="form-control col-3 offset-7"/>
                                                    <button type="" className="btn btn-sm btn-primary col-1"> <i className="fa fa-search"></i></button>
                                                </div>
                                            </div>
